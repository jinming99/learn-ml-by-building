...
:::{.callout-note}
## Fall 2026
This is an individual assignment worth 10% of the course grade. It is due Tuesday, October 6, at 11:59 p.m. ET. See the [live schedule](../schedule.qmd) for updates.
:::
...
:::{.callout-tip}
## Quick Access
**[Project Notebook (GitHub)](https://github.com/jinming99/learn-ml-by-building/blob/main/Project%202%20Neural%20Archaeology/Neural_Archaeology_Student.ipynb)** — Complete implementation guide and assignment

**[Setup Guide](https://github.com/jinming99/learn-ml-by-building/blob/main/Project%202%20Neural%20Archaeology/README.md)** — Colab and local setup instructions
:::
...
**Previous**: [← Project 1: Music Recommender](project1.qmd) | **Next**: [Project 3: Thought Cascade →](thought_cascade.qmd)
