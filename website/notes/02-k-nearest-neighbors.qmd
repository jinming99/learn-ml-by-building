...
<a class="pdf-icon-link" href="https://github.com/jinming99/learn-ml-by-building/raw/main/Lecture%20Notes/lecture-02-k-nearest-neighbors.pdf" target="_blank" rel="noopener" aria-label="Download Lecture 2 PDF" title="Download PDF"><i class="bi bi-file-earmark-pdf-fill" aria-hidden="true"></i><span class="visually-hidden">Download Lecture 2 PDF</span></a>
[Course materials](../lectures/02-knn.qmd){.btn .btn-outline-primary}
[Previous native note](01-what-is-machine-learning.qmd){.btn .btn-outline-secondary}
:::
