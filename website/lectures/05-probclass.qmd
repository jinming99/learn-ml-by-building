...
- [Lecture notes](../notes/05-probabilistic-classification.qmd)
- [PDF version](https://github.com/jinming99/learn-ml-by-building/raw/main/Lecture%20Notes/lecture-05-probabilistic-classification.pdf)
...
:::{.callout-note}
## AI Fluency Quiz Sample

- [Sample quiz (PDF)](../quizzes/files/quiz-05-ai-fluency-sample.pdf)
- [How to answer: student guide (PDF)](../quizzes/files/ai-fluency-quiz-student-guide.pdf)
- [All AI Fluency quizzes](../quizzes/index.qmd)

The sample is not for credit. It shows the two-pass format we may use in future classes.
:::
