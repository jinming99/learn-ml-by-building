...
- [Lecture notes](../notes/07-regularization-and-generalization.qmd)
:::

::: {.callout-note}
### Questions to investigate

- Model size: must validation error rise when the model has many parameters?
- Data coverage: which training variations help under a specified lighting change?
- Regularization: did accuracy, probability quality, or resistance to incorrect labels improve?
:::
